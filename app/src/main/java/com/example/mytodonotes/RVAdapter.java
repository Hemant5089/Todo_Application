...
import com.example.mytodonotes.databinding.EachRvBinding;
...
public class RVAdapter extends ListAdapter<Note,RVAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.each_rv,parent,false));
